...
Columns = `r ncol(nobel)`

Each row represent a nobel winner.
...
```
 ...
 the majority of Nobel laureates, particularly in the sciences, won their awards in the United States.
